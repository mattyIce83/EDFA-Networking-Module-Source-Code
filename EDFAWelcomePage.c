...
extern unsigned char earOutputPowerSetpointValue_temp[];
...
static char PgEDFAChassisManager_Item_16[] =
	...
	"                " C_xTD C_xTR C_oTR "\n"
	"                <td class=\"tableHeaderTextCentered\">Output Power "
	"Setpoint 2" C_xTD "<td class=\"tableBorderTextCentered\">dBm" C_xTD
	"<td class=\"tableBorderTextCentered\">\n"
	"                    ";

extern unsigned char earOutputPower2SetpointValue_temp[];
