...
unsigned long earOutputPowerSetpointValue_temp = 0;

extern void SetOutputPowerSetpointValue(int theValue);
void SetOutputPowerSetpointValue(int theValue) {

	powerSetpoint = theValue;
	return;
}

unsigned long earOutputPower2SetpointValue_temp = 0;

extern void SetOutputPower2SetpointValue(int theValue);
void SetOutputPower2SetpointValue(int theValue) {
